...
export default function AuthPage() {
    ...
    try {
      if (isSignUp) {
        const { error } = await supabase.auth.signUp({
          email,
          password,
          options: { emailRedirectTo: "com.alnoorway.codexus.app://home" },
        });
        if (error) throw error;
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-100 p-4"
      dir="rtl"
    >
        ...
        <CardContent>
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            ...
            <Button
              ...
              disabled={loading}
              className="bg-black text-white hover:bg-slate-800 flex gap-2"
            >
              <svg
                className="w-4 h-4"
                viewBox="0 0 384 512"
